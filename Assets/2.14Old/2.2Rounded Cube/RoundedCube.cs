...
public class RoundedCube : MonoBehaviour
{
    ...
    private void CreateTriangles()
    {
        ...
        mesh.SetTriangles(trianglesX, 2);
    }
    ...
    private static int SetQuad(int[] triagnles, int i, int v00, int v01, int v10, int v11)
    {
        triagnles[i] = v00;
        triagnles[i + 1] = triagnles[i + 4] = v10;
        triagnles[i + 2] = triagnles[i + 3] = v01;
        triagnles[i + 5] = v11;
        return i + 6;
    }
